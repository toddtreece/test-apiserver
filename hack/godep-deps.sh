...
mkdir -p ${goPath}/src/github.com/toddtreece/test-apiserver
cp -R . ${goPath}/src/github.com/toddtreece/test-apiserver

pushd ${goPath}/src/github.com/toddtreece/test-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/github.com/toddtreece/test-apiserver/vendor .
mv ${goPath}/src/github.com/toddtreece/test-apiserver/Godeps .
git add vendor
git add Godeps
